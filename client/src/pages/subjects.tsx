    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400">Manage your study subjects and track progress</p>
        </div>
        ...
        <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
          <DialogContent className="glass sm:max-w-md">
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid gap-2">
                <label htmlFor="edit-progress" className="text-sm font-medium">Progress ({newSubject.progress}%)</label>
                <Input
                  id="edit-progress"
                  type="range"
                  min="0"
                  ...
                  onChange={(e) => setNewSubject({ ...newSubject, progress: parseInt(e.target.value) })}
                />
              </div>
            </div>
            <DialogFooter>
        ...
        <Card className="glass">
          <CardContent className="flex flex-col items-center justify-center py-12">
            <div className="rounded-full bg-gray-100 dark:bg-gray-800 p-4 mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-500 dark:text-gray-400"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20"/></svg>
            </div>
            <h3 className="text-lg font-medium mb-2">No subjects found</h3>
            <p className="text-gray-500 dark:text-gray-400 text-center max-w-md">
              You haven't added any subjects yet. Add a subject to start tracking your progress.
            </p>
            <Button 
              className="mt-4"
            ...
            <Card key={subject.id} className="glass hover-scale">
              <CardHeader className="p-6 pb-2">
                <div className="flex justify-between items-start">
                  <CardTitle className="font-semibold text-lg">{subject.name}</CardTitle>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="font-medium">
                        {data.studySessions.filter(session => session.subjectId === subject.id).length}
                      </p>
                    </div>
                    <div>
