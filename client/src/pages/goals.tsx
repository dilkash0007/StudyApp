...
export default function Goals() {
  ...
  const openEditDialog = (goal: typeof data.goals[0]) => {
  ...
  const handleIncrementProgress = (id: number, current: number, target: number) => {
    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400">Set and track your study targets</p>
        </div>
        ...
        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
          ...
          <DialogContent className="glass sm:max-w-md">
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid gap-2">
                <label htmlFor="current" className="text-sm font-medium">Current Progress</label>
                <Input
                  id="current"
                  type="number"
                  min="0"
        ...
        <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
          <DialogContent className="glass sm:max-w-md">
            ...
            <div className="grid gap-4 py-4">
              <div className="grid gap-2">
                <label htmlFor="edit-title" className="text-sm font-medium">Goal Title</label>
                <Input
                  id="edit-title"
                  placeholder="Enter goal title"
                  value={newGoal.title}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-2">
                  <label htmlFor="edit-target" className="text-sm font-medium">Target</label>
                  <Input
                    id="edit-target"
                    type="number"
                    min="1"
              ...
              <div className="grid gap-2">
                <label htmlFor="edit-current" className="text-sm font-medium">Current Progress</label>
                <Input
                  id="edit-current"
                  type="number"
                  min="0"
        ...
        <Card className="glass">
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-center max-w-md">
              You haven't created any goals yet. Add a goal to start tracking your progress.
            </p>
            <Button 
              className="mt-4"
              ...
              <Card key={goal.id} className="glass hover-scale transition-all">
                <CardHeader className="p-6 pb-2">
                  <div className="flex justify-between items-start">
                    <CardTitle className="font-semibold text-lg">{goal.title}</CardTitle>
                ...
                <CardContent className="p-6 pt-2">
                  ...
                  <div className="flex justify-between mt-6">
                    <Button 
                      variant="outline" 
                      size="sm"
                      onClick={() => handleDecrementProgress(goal.id, goal.current)}
                    ...
                    <Button 
                      variant="outline" 
                      size="sm"
                      onClick={() => handleIncrementProgress(goal.id, goal.current, goal.target)}
      ...
      {/* Tips Section */}
      <div className="mt-10">
        <h3 className="text-lg font-medium mb-4">Tips for Setting Effective Goals</h3>
        <Card className="glass">
          <CardContent className="p-6">
            <ul className="space-y-3 list-disc pl-5">
              <li>
                <span className="font-medium">Be specific:</span>
                <span className="text-gray-600 dark:text-gray-400"> Set clear, measurable goals like "Read 30 pages" instead of "Read more".</span>
              </li>
              <li>
                <span className="font-medium">Break it down:</span>
                <span className="text-gray-600 dark:text-gray-400"> Divide larger goals into smaller, manageable tasks.</span>
              </li>
              <li>
                <span className="font-medium">Track regularly:</span>
                <span className="text-gray-600 dark:text-gray-400"> Update your progress daily to stay motivated.</span>
              </li>
              <li>
                <span className="font-medium">Reward yourself:</span>
                <span className="text-gray-600 dark:text-gray-400"> Celebrate when you reach milestones.</span>
              </li>
              <li>
                <span className="font-medium">Review and adjust:</span>
                <span className="text-gray-600 dark:text-gray-400"> Periodically evaluate your goals and modify them if needed.</span>
              </li>
            </ul>
          </CardContent>
        </Card>
