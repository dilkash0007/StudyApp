      ...
      <div className="container flex flex-col lg:flex-row gap-10 items-center justify-between px-4 py-8 max-w-7xl">
        ...
        <div className="w-full lg:w-1/2 max-w-md">
          <Card className="glass border-0 shadow-xl">
            <CardHeader>
              <CardTitle className="text-2xl text-center">StudyTracker</CardTitle>
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          <h1 className="text-4xl font-bold mb-4 text-gray-800 dark:text-white">Study Smarter, Not Harder</h1>
          <p className="text-lg mb-6 text-gray-600 dark:text-gray-300">
            Track your study sessions, manage tasks, take notes, and reach your academic goals with our comprehensive study tracking app.
          </p>
          <div className="flex flex-wrap gap-4 justify-center lg:justify-start mb-8">
            <div className="flex items-center bg-white dark:bg-gray-800 rounded-lg p-3 shadow-md">
              ...
              <div>
                <h3 className="font-medium text-gray-900 dark:text-white">Track Study Time</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">Log your study sessions</p>
              </div>
            </div>
            <div className="flex items-center bg-white dark:bg-gray-800 rounded-lg p-3 shadow-md">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Stay on top of assignments</p>
              </div>
            </div>
            <div className="flex items-center bg-white dark:bg-gray-800 rounded-lg p-3 shadow-md">
              ...
              <div>
                <h3 className="font-medium text-gray-900 dark:text-white">Take Notes</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">Organize study materials</p>
              </div>
            </div>
            <div className="flex items-center bg-white dark:bg-gray-800 rounded-lg p-3 shadow-md">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Track progress & achievements</p>
              </div>
            </div>
          </div>
          <div className="glass p-4 rounded-xl shadow-lg">
            <p className="italic text-gray-600 dark:text-gray-300">
              "StudyTracker has helped me improve my productivity and stay organized with my coursework. The visual progress tracking is a game-changer!"
            </p>
