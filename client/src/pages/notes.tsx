...
export default function Notes() {
  ...
  const getNoteBgClass = (subjectId: number | null) => {
    ...
    if (subjectInfo.name === "Mathematics")
      return "bg-primary-50 dark:bg-gray-800";
    if (subjectInfo.name === "Science")
      return "bg-secondary-50 dark:bg-gray-800";
  ...
  const getNoteBadgeClass = (subjectId: number | null) => {
    ...
    if (subjectInfo.name === "Science")
      return "bg-secondary-100 dark:bg-secondary-900 text-secondary dark:text-secondary-300";
    if (subjectInfo.name === "History")
      return "bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300";
    if (subjectInfo.name === "English")
      return "bg-accent-100 dark:bg-accent-900 text-accent";
    return "bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300";
  };
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400">
            Organize your study notes and key concepts
          </p>
        </div>
          ...
          <DialogContent className="glass sm:max-w-md">
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid gap-2">
                ...
                <Select
                  value={newNote.subjectId?.toString() || "none"}
                  onValueChange={(value) =>
                    setNewNote({
                      ...newNote,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {sortedNotes.map((note) => {
            ...
            return (
              ...
              >
                <CardContent
                  className={`p-5 ${getNoteBgClass(note.subjectId)}`}
                >
                  <div className="flex items-center justify-between mb-2">
                    <span
                      className={`text-xs px-2 py-1 rounded-full ${getNoteBadgeClass(
                        note.subjectId
                      )}`}
                    >
                      {subjectInfo.name}
