    ...
    <Card className="glass rounded-2xl p-6 shadow-lg hover-scale transition-all h-full">
      <CardHeader className="p-0 mb-6">
        <div className="flex justify-between items-start">
          <CardTitle className="font-semibold text-lg">Start Studying</CardTitle>
        ...
        <div className="flex flex-col items-center mb-4">
          <div className="relative w-40 h-40 mx-auto mb-4">
            <svg className="w-full h-full" viewBox="0 0 100 100">
              <circle cx="50" cy="50" r="45" fill="none" stroke="#E5E7EB" strokeWidth="5" className="dark:stroke-gray-700"></circle>
              <circle 
                cx="50" 
                cy="50" 
                r="45" 
            ...
            <div className="absolute inset-0 flex items-center justify-center flex-col">
              ...
              <span className="text-sm text-gray-500 dark:text-gray-400">minutes left</span>
            </div>
          </div>
